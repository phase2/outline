...
export class FormSubmitController implements ReactiveController {
  ...
  hostConnected() {
    this.form = this.options.form(this.host as unknown as HTMLInputElement);
  ...
  handleFormData(event: FormDataEvent) {
    const disabled = this.options.disabled(
      this.host as unknown as HTMLInputElement
    );
    const name = this.options.name(this.host as unknown as HTMLInputElement);
    const value = this.options.value(this.host as unknown as HTMLInputElement);
  ...
  handleFormSubmit(event: Event) {
    ...
    if (
      ...
      !disabled &&
      !reportValidity(this.host as unknown as HTMLInputElement)
    ) {
