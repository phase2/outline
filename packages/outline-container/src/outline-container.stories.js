...
`,
    ...
    argTypes: {
        containerAlign: Object.assign(Object.assign({}, argTypeHorizontalAlign), { name: 'container-align', description: 'How the container should align to the parent.', table: { category: 'Properties', defaultValue: { summary: 'center' } } }),
        xPadding: {
            name: 'x-padding',
        ...
        fullBleed: {
            name: 'full-bleed',
            description: 'If the container should be full bleed and extend its left and right edges to edge of parent.',
            table: { category: 'Properties', defaultValue: { summary: 'false' } },
            control: {
                type: 'boolean',
            },
...
export const Container = ({ xPadding, yPadding, fullBleed, containerAlign, }) => html `
<outline-container
...
>
  ...
  `;
//# sourceMappingURL=outline-container.stories.js.map