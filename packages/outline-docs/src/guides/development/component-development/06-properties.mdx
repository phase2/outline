  ...
  {() => {
    return html`
      <outline-code-block language="typescript" class="mb-6">
        /** * This is a description of stringProperty. * It provides a default
        value of "Default Property Value". */ @property({type: String,
        attribute: 'string-property'}) stringProperty = 'Default Property Value'
      </outline-code-block>
    `;
  }}
</Story>
...
<Story name="Without default value">
  {() => {
    return html`
      <outline-code-block language="typescript" class="mb-6">
        /** * This is a description of stringProperty. * It does not provide a
        default value, therefore is NULL by default. */ @property({type: String,
        attribute: 'string-property'}) stringProperty
      </outline-code-block>
    `;
  }}
</Story>
...
<Story name="Property: String">
  {() => {
    return html`
      <outline-code-block language="typescript" class="mb-6">
        /** * This is a description of stringProperty. */ @property({type:
        String, attribute: 'string-property'}) stringProperty = 'Default string
        value'
      </outline-code-block>
    `;
  }}
...
<Story name="Property: Number">
  {() => {
    return html`
      <outline-code-block language="typescript" class="mb-6">
        /** * This is a description of numberProperty. */ @property({type:
        Number, attribute: 'number-property'}) numberProperty = 42
      </outline-code-block>
    `;
  }}
</Story>
...
<Story name="Property: Boolean">
  {() => {
    return html`
      <outline-code-block language="typescript" class="mb-6">
        /** * This is a description of booleanProperty. */ @property({type:
        Boolean, attribute: 'boolean-property'}) booleanProperty = false
      </outline-code-block>
    `;
  }}
</Story>
...
<Story name="Property: Object">
  {() => {
    return html`
      <outline-code-block language="typescript" class="mb-6">
        /** * This is a description of objectProperty. */ @property({type:
        Object, attribute: 'object-property'}) objectProperty = { thingOne:
        'value', thingTwo: 'value' }
      </outline-code-block>
    `;
  }}
</Story>
...
<Story name="Property: Array">
  {() => {
    return html`
      <outline-code-block language="typescript" class="mb-6">
        /** * This is a description of arrayProperty. */ @property({type: Array,
        attribute: 'array-property'}) arrayProperty = [ { thingOne: 'value' }, {
        thingOne: 'value' } ]
      </outline-code-block>
    `;
  }}
