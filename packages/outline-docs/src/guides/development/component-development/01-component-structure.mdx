...
Anytime you need to use a base component, you must extend it. Base components are always named 'outline-core-componentName' by default. The extended name should simply be 'outline-componentName'. This example is the most basic form of extending which just replaces the base styles with any custom project styles you may have. Note: You will need to create a new stylesheet in your extended component directory.
