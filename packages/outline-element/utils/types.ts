import tailwindConfig from '../../../src/resolved-tailwind-config';
export { ALL_COLORS } from '../../../src/resolved-tailwind-config';

/**
 * Pass along all the Tailwind colors
 */
export type { Color } from '../../../src/resolved-tailwind-config';
