...
<outline-container container-width="wide" top-margin="spacing-6" bottom-margin="spacing-12" component-spacing="spacing-2">
  <outline-core-alert status="info" size="large">
...
<outline-container container-width="medium" top-margin="spacing-0" bottom-margin="spacing-12" component-spacing="spacing-2">
  <outline-core-alert status="info" size="large">
...
<outline-container container-width="narrow" top-margin="spacing-0" bottom-margin="spacing-12" component-spacing="spacing-2">
  <outline-core-alert status="info" size="large">
...
<outline-container container-width="narrow" top-margin="spacing-0" bottom-margin="spacing-12" component-spacing="spacing-2" justify-end>
  <outline-core-alert status="info" size="large">
...
<outline-container container-width="narrow" top-margin="spacing-0" bottom-margin="spacing-12" component-spacing="spacing-2" component-spacing="spacing-2" justify-start>
  <outline-core-alert status="info" size="large">
