...
<outline-container container-width="wide" top-margin="spacing-0" bottom-margin="spacing-12" component-spacing="spacing-2">
  <outline-alert statusType="info" size="large">
...
<outline-container container-width="narrow" top-margin="spacing-0" bottom-margin="spacing-12">
  <outline-alert statusType="info" size="large">
...
<outline-container container-width="narrow" top-margin="spacing-0" bottom-margin="spacing-12" justify-end>
  <outline-alert statusType="info" size="large">
...
<outline-container container-width="narrow" top-margin="spacing-0" bottom-margin="spacing-0" component-spacing="spacing-2" justify-start>
  <outline-alert statusType="info" size="large">
