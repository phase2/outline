...
describe(AccordionElementName, () => {
  ...
  it('Panels slot content.', () => {
    const accordionInstance = document.createElement(AccordionElementName);
    const panelInstance = document.createElement(PanelElementName);
...
//# sourceMappingURL=outline-accordion.test.js.map
