...
<Meta
  title="Documentation/Guides/Developer/Unit Testing"
  parameters={{
    viewMode: 'docs',
    previewTabs: {
      canvas: {
...
Test files should be located in a test folder in your component directory with a `.test.ts` extension i.e. `src/components/ghs/ghs-example/test/ghs-example.test.ts`
